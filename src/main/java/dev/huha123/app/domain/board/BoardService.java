...
public class BoardService {
    ...
    private final dev.huha123.app.domain.like.LikeService likeService;
    ...
    public BoardDto getBoardById(Long id, java.security.Principal principal) {
        ...
        boardEntity.setLikeCount(likeService.getLikeCount(dev.huha123.app.domain.like.LikeType.BOARD, boardEntity.getId()));
        if (principal != null) {
            boardEntity.setLiked(likeService.isLiked(principal.getName(), dev.huha123.app.domain.like.LikeType.BOARD, boardEntity.getId()));
        }
